...
const steps = [
    ...
    options: [
      {
        ...
        icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><path d="M9 22V12h6v10"/></svg>,
      },
      {
      ...
      },
      {
        ...
        icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="9"/><path d="M12 7v10M9.5 9.5c0-1.4 1.1-2.5 2.5-2.5s2.5.7 2.5 2c0 2-5 1.5-5 3.5 0 1.3 1.1 2 2.5 2s2.5-1.1 2.5-2.5"/></svg>,
      },
      {
        value: 'vedouci', label: 'Vedoucí týmu / Manažer',
  ...
  {
    title: 'Na co se zaměřuješ?',
    desc: 'Nastavíme šablony a terminologii pro tvůj obor.',
    key: 'industry',
    options: [
      {
        value: 'prodej', label: 'Prodej nemovitostí',
        icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><path d="M9 22V12h6v10"/></svg>,
      },
      {
        value: 'pronajem', label: 'Pronájem nemovitostí',
      ...
      {
        value: 'financni_poradenstvi', label: 'Finanční poradenství',
        icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="9"/><path d="M12 7v10M9.5 9.5c0-1.4 1.1-2.5 2.5-2.5s2.5.7 2.5 2c0 2-5 1.5-5 3.5 0 1.3 1.1 2 2.5 2s2.5-1.1 2.5-2.5"/></svg>,
      },
      {
        value: 'kancelar', label: 'Realitní kancelář s více makléři',
