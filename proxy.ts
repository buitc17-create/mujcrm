...
export async function proxy(request: NextRequest) {
  ...
  const isPublic = publicRoutes.some(r => pathname === r || pathname.startsWith('/auth/') || pathname.startsWith('/onboarding') || pathname.startsWith('/blog') || pathname.startsWith('/funkce') || pathname.startsWith('/admin')) || pathname.startsWith('/api/');
