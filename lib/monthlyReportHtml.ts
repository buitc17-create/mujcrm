    ...
    <table width="100%" cellpadding="0" cellspacing="0">
      <tr>
        <td width="50%" style="padding:0 6px 0 0;">
          <div style="background:#f0fdf4; border:1px solid #bbf7d0; border-radius:10px; padding:16px 20px;">
            ...
            ${p.wonProvize > 0 ? `<div style="font-size:12px; font-weight:700; color:#b45309; margin-top:8px; padding-top:8px; border-top:1px solid #d1fae5;">Provize (bez DPH): ${p.wonProvize.toLocaleString('cs-CZ')} Kč</div>` : ''}
          </div>
        </td>
      ...
      <tr><td colspan="2" style="padding-top:10px;">
        <div style="background:#fffbeb; border:1px solid #fde68a; border-radius:10px; padding:16px 20px;">
          <div style="font-size:11px; color:#b45309; font-weight:700; text-transform:uppercase; letter-spacing:0.5px; margin-bottom:6px;">Výhled provize bez DPH (z otevřených zakázek)</div>
